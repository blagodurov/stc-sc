...
# 
# Version 1.2
# Usage (requres python 3 and above): 
# LANG=it_IT.UTF-8
# export LANG
# python member-counting.v1.2.py
# Instructions:
...
#        exit(2)
    ...
    mbase_page0 = "http://m.facebook.com/groups/260557033966377?view=members"
    mbase_page = 'http://m.facebook.com/browse/group/members/?id=260557033966377&start='
    mm = []
    mpage = 0
    while True:
        if mpage == 0:
    ...
    for i in m:
        ...
        for j in range(1, 3):
            ...
            if ms:
                ...
                ms = re.search('firstName=([\w]+)', cont.decode('utf8'))
                if ms:
                    first_name = ms.group(1)
            ...
            if ms:
                ...
                ms = re.search('lastName=([\w]+)', cont.decode('utf8'))
                if ms:
                    last_name = ms.group(1)
